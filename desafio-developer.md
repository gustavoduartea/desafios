...
- Usar NestJS como backend.
- Usar React, Vue ou HTMX como frontend.
- Cobertura de código acima de 65%.
- README explicando como executar seu projeto.

## Opcional, mas seria muito bom
- Utilizar Docker para montar o ambiente (incluindo dependências).
- Utilizar BulmaCSS na parte do CSS.
...
Quaisquer dúvidas que você venha a ter, consulte as _issues_ para ver se alguém já não a fez e caso você não ache sua resposta, abra você mesmo uma nova issue, acrescentando o prefixo "Desafio Full-Stack Developer" no título!
